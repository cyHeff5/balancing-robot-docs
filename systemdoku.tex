...
In der ersten Software-Iteration lief die Bildverarbeitung (Ball-Detektion) sequenziell zur Regelschleife. Da die Kamera maximal 30 Frames pro Sekunde liefert, limitierte dies den Regler auf etwa 30\,Hz, was für eine stabile Regelung nicht ausreicht. Um dies zu beheben, wurde die Softwarearchitektur auf Multithreading umgestellt. Die Kamera-Schleife läuft nun entkoppelt in einem Hintergrund-Thread. Der Regler läuft stabil mit $120$\,Hz. Liegt kein neues Kamerabild vor, prädiziert der Regler die aktuelle Position des Balls basierend auf den letzten Geschwindigkeitsvektoren, was eine hochfrequente, flüssige Regelung ermöglicht.
