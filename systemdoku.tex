...
\section{Mechanik \textit{(Simon Bernarding)}}
...
Des Weiteren wählte ich ein Grunddesign, das die Servo Kurbel in der Nulllage parallel zur Standfläche orientiert ist. Mit einem positiven und negativen Arbeitsraum ergibt sich so eine maximale Änderung der Plattform bei eher kleineren Winkeländerungen des Servowinkels.
...
\subsection{Konstruieren der Ersten Version}
...
\subsection{Verbesserung der Mechanik mit zweiter Version}
...
\subsubsection{Neue Lagerung Mittleres Knickarmgelenk}
...
\subsubsection{Weitere Merkmale der Konstruktion}
