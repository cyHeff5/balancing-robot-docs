...
Kamerainitialisierung bei jedem Bildabruf. Eine erneute Latenzmessung
mit dieser Konfiguration steht noch aus und kann mit dem Skript
\texttt{measure\_latency.py} durchgeführt werden.
