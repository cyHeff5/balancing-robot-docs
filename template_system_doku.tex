...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north west]
    at ([xshift=8mm, yshift=-8mm]current page.north west) {%
  ...
  \node[anchor=south east, align=right]
    at ([xshift=-8mm, yshift=0.45\paperheight+8mm]current page.south east) {%
      {\fontsize{46}{50}\selectfont\bfseries\color{white}Balancing Robot}\\[3pt]
    };

  % "Systemdokumentation" oben links im weißen Block
  \node[anchor=north west, align=left]
    at ([xshift=14mm, yshift=0.45\paperheight-10mm]current page.south west) {%
