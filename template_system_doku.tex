...
\begin{titlepage}
  ...
  \begin{tikzpicture}[x=1mm, y=1mm]
    ...
    \node[anchor=south east, align=right] at (202,142) {%
      {\fontsize{36}{42}\selectfont\bfseries\color{white}Balancing Robot}\\[3pt]
      {\large\bfseries\color{white}Systemdokumentation}%
    };

    % "Systemdokumentation" oben links im weißen Block
    \node[anchor=north west, align=left] at (14,126) {%
      {\large\bfseries\color{black}Systemdokumentation}\\[5pt]
