...
%
\begin{titlepage}
  \newgeometry{top=0pt, bottom=0pt, left=0pt, right=0pt, noheadfoot}
  % Absolutes Layout in mm (A4 = 210 x 297 mm, Ursprung unten links)
  % Trennung bei y=134mm (= 45% von unten; blauer Block oben = 163mm)
  \noindent
  \begin{tikzpicture}[x=1mm, y=1mm]
    ...
    \node[anchor=south east, align=right] at (202,142) {%
      {\fontsize{46}{42}\selectfont\bfseries\color{black}Balancing Robot}\\[3pt]
    };

    % "Systemdokumentation" oben links im weißen Block
    \node[anchor=north west, align=left] at (14,126) {%
      {\fontsize{26}{42}\selectfont\bfseries\color{black}Systemdokumentation}\\[5pt]
      {\Large\color{htbtextgray}HTW Saar · WiSe 2025/26}%
    };

    % HTW-Logo unten rechts
    \node[anchor=south east] at (196,12) {%
