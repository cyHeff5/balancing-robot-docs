...
% Hilfsmakro nötig: tcolorbox mit #1 direkt in \titleformat
% führt zu "Illegal parameter number" in titlesec
\newcommand{\chapterheadbox}[1]{%
  \noindent
  % Schmaler dunkler Balken links
  \colorbox{htbdark}{%
    \color{htbdark}\rule[-3mm]{0pt}{16mm}\hspace*{4mm}}%
  % Blauer Kasten mit Titel (auto-Breite)
  \colorbox{htbblue}{%
    \color{white}\rule[-3mm]{0pt}{16mm}\hspace*{5mm}%
    {\bfseries\Large #1}\hspace*{5mm}}%
  \par\vspace{8pt}%
}
\titleformat{\chapter}[block]
  ...
  {0pt}
  {\chapterheadbox}
\titlespacing*{\chapter}{0pt}{-18mm}{10pt}

% Abschnittsüberschriften
\newcommand{\sectionrule}{{\color{htbblue}\titlerule[0.6pt]}}
\titleformat{\section}
